...
public class KruskalMST {
    //保留最小生成树的所有边
    private Queue<com.itCs520.deanProject.Basic.Day10.Digraph.Edge> mst;
    //索引代表顶点,使用uf_connect(v,w)可以判断顶点v和顶点w是否在同一树中 使用uf.union(v,w)可以把顶点v所在的树和顶点w所在的树进行合并
    private UF_tree_Weighted uf;
    //存储图中的所有边，使用最小优先队列，对边按照权重进行排序
    private MinpriorityQueue<com.itCs520.deanProject.Basic.Day10.Digraph.Edge> pq;
    ...
    public KruskalMST(EdgeWeightedGraph G){
        ...
        //把图中所有的边存储到pq中
        for (com.itCs520.deanProject.Basic.Day10.Digraph.Edge e : G.edges()) {
            pq.insert(e);
        }
