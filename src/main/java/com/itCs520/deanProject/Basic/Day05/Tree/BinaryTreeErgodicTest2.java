...
import com.itCs520.deanProject.Basic.Day05.Tree.BinaryTreeErgodic2;
...
//        BinaryTreeLayerErgodic<String, String> tree = new BinaryTreeLayerErgodic<>();
        com.itCs520.deanProject.Basic.Day05.Tree.BinaryTreeErgodic2<String, String> tree = new BinaryTreeErgodic2<>();
        //测试插入操作
        tree.put("E","5");
        tree.put("B","2");
        tree.put("G","7");
