...
import com.itCs520.deanProject.Basic.Day09.graph.BreadthFirstSearch;
import com.itCs520.deanProject.Basic.Day09.graph.Graph;

public class BreadthFirstSearchTest {
    public static void main(String[] args) {
        //准备Graph对象
        com.itCs520.deanProject.Basic.Day09.graph.Graph G = new Graph(13);
        G.addEdge(0,5);
        G.addEdge(0,1);
        G.addEdge(0,2);
        G.addEdge(0,6);
        ...
        //准备广度优先搜索对象
        com.itCs520.deanProject.Basic.Day09.graph.BreadthFirstSearch search = new BreadthFirstSearch(G, 0);
        //测试与某个顶点相通的数量
