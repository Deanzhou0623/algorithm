...
import com.itCs520.deanProject.Basic.Day04.linear.TowWayLinkList;

public class TowWayLinkListTest {
    public static void main(String[] args) {
        //创建顺序表对象

        com.itCs520.deanProject.Basic.Day04.linear.TowWayLinkList<String> s1 = new TowWayLinkList<>();
